...
import { sendInvoiceWhatsApp } from "../components/Handleprint"; 
...
function InvoicePage({ isPublicView = false }) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4" id="invoice">
      {/* Header */}
      ...
      <div className="print:hidden mt-6 flex flex-col sm:flex-row gap-4">
         ...
         <button
    onClick={() => handlePrint(customer, fromDate, toDate, transactions)}
    ...
    Print
        ...
        {!isPublicView && (
          <button
            onClick={() => sendInvoiceWhatsApp(customer, fromDate, toDate, transactions)}
