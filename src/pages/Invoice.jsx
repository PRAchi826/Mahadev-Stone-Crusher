...
const handlePrint = () => {
  ...
  const countryCode = '91'; // Change this as needed
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4">From: Mahadev Stone Crusher</h2>
      <h2 className="text-2xl font-bold mb-4">To: {customer.name}</h2>
     ...
     <div className="print:hidden mt-4 flex gap-4">
  <button
    onClick={handlePrint}
